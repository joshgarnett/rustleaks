...
| --- | --- |
| Regex compile | 1 MiB source, nesting 4,096, nested repeat product 1,000, compiled NFA 256 MiB, estimated PikeVM search working set 256 MiB; limits are per expression |
